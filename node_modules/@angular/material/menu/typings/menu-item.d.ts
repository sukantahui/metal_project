...
export declare class MatMenuItem extends _MatMenuItemMixinBase implements FocusableOption, CanDisable, OnDestroy {
    ...
    getLabel(): string;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MatMenuItem, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MatMenuItem, "[mat-menu-item]", ["matMenuItem"], { "disabled": "disabled"; }, {}, never, ["*"]>;
}

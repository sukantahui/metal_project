...
export declare class MatButtonToggleGroup extends _MatButtonToggleGroupMixinBase implements ControlValueAccessor, CanDisable {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<MatButtonToggleGroup, "mat-button-toggle-group:not([multiple])", ["matButtonToggleGroup"], { "disabled": "disabled"; "name": "name"; "vertical": "vertical"; "value": "value"; "selected": "selected"; }, { "change": "change"; }, ["_buttonToggles"]>;
}
...
export declare class MatButtonToggle implements OnInit, OnDestroy {
     ...
     */
    _markForCheck(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MatButtonToggle, [{ optional: true; }, { optional: true; }, null, null, null, null, null]>;
